...
0210 D455 SHOW 5MI@V4V5   ;2桁目の数字パターンを表示
...
020C E3A1 SKIP;V3 NE KEY   ;左のキーが押されなかったらスキップ
020E 71FF V1+FF            ;Xの値を1減らす
0210 E4A1 SKIP;V4 NE KEY   ;右のキーが押されなかったらスキップ
0212 7101 V1+1             ;Xの値を1増やす
...
```
W0200 A2 18 61 00 62 00 63 04 64 06 D1 28 E3 A1 71 FF
W0210 E4 A1 71 01 00 E0 12 0A FF 81 81 81 81 81 81 FF
```
...
0214 D455 SHOW 5MI@V4V5      ;2桁目の数字パターンを表示
