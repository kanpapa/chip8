...
0206 6400 V4=00           ;画面表示位置Xを0に設定する
0208 6500 V5=00           ;画面表示位置Yを0に設定する
020A F633 MI=V6(3DD)      ;V6の値を10進数にしてIのアドレスに3桁にして書き込む
020C F265 V0:V2=MI        ;Iのアドレスにある10進の値をV0,V1,V2にセットする。
020E 6400 V4=00           ;画面表示位置Xを0に設定する
0210 6500 V5=00           ;画面表示位置Yを0に設定する
...
021C 1200 GO 0200         ;次のキー入力を待つために$0200に飛ぶ
```

- バイナリ

```
W0200 F6 0A 00 E0 A3 00 64 00 65 00 F6 33 F2 65 64 00
W0210 65 00 F1 29 D4 55 74 05 F2 29 D4 55 12 00
```
