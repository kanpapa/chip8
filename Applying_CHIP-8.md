...
```
0200 F00A V0=KEY          ;16進キーが押されるまで待ち、押されたらキーの値をV0に代入する
0202 A300 I=0300          ;メモリポインタIを$300に設定する
0204 6400 V4=00           ;画面表示位置Xを0に設定する
0206 6500 V5=00           ;画面表示位置Yを0に設定する
0208 F029 I=V0(LSDP)      ;メモリポインタIで示すメモリにV0の値の表示パターンをセットする
020A 00E0 ERASE　         ;画面を消去する
020C D455 SHOW 5MI@V4V5   ;画面位置(X,Y)に、メモリポインタIのメモリに格納された表示パターンを表示する
022E 1200 GO 0200         ;次のキー入力を待つために$0200に飛ぶ
```

- バイナリ

```
W0200 F0 0A A3 00 64 00 65 00 F0 29 00 E0 D4 55 12 00
```
